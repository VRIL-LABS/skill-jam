...
description: Build integration tests — API testing, database testing, and service integration. Use when testing integrations, validating APIs, or testing data flows.
---
...
Invoke this skill when you need to work with integration test builder in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for integration-test-builder"
```
...
Description of a basic use case for integration-test-builder.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure integration-test-builder
        run: |
          # Setup commands
          echo "Configuring integration-test-builder"
```
