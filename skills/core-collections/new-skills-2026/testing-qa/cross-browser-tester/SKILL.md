...
description: Test across browsers — compatibility testing and automation. Use when ensuring browser compatibility, testing legacy browsers, or validating responsive design.
---
...
Invoke this skill when you need to work with cross browser tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cross-browser-tester"
```
...
Description of a basic use case for cross-browser-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cross-browser-tester
        run: |
          # Setup commands
          echo "Configuring cross-browser-tester"
```
