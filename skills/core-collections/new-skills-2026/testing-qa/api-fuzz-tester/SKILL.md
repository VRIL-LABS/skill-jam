...
description: Fuzz test APIs — security testing and input validation. Use when finding API vulnerabilities, testing input handling, or security testing.
---
...
Invoke this skill when you need to work with api fuzz tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for api-fuzz-tester"
```
...
Description of a basic use case for api-fuzz-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure api-fuzz-tester
        run: |
          # Setup commands
          echo "Configuring api-fuzz-tester"
```
