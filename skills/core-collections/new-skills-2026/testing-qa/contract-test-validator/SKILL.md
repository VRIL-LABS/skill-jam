...
description: Validate API contracts with Pact or Spring Cloud Contract. Use when testing microservice interactions, preventing breaking changes, or implementing consumer-driven contracts.
---

# contract-test-validator

Validate api contracts with pact or spring cloud contract. use when testing microservice interactions, preventing breaking changes, or implementing consumer-driven contracts..

## When to Use

Invoke this skill when you need to work with contract test validator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for contract-test-validator"
```
...
Description of a basic use case for contract-test-validator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure contract-test-validator
        run: |
          # Setup commands
          echo "Configuring contract-test-validator"
```
