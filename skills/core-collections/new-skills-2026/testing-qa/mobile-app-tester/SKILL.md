...
description: Test mobile applications — Appium, Detox, or Espresso tests. Use when testing iOS/Android apps, automating mobile tests, or validating mobile UX.
---
...
Invoke this skill when you need to work with mobile app tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for mobile-app-tester"
```
...
Description of a basic use case for mobile-app-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure mobile-app-tester
        run: |
          # Setup commands
          echo "Configuring mobile-app-tester"
```
