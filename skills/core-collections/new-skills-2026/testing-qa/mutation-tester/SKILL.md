...
description: Perform mutation testing — test quality assessment. Use when improving test coverage, finding weak tests, or validating test effectiveness.
---
...
Invoke this skill when you need to work with mutation tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for mutation-tester"
```
...
Description of a basic use case for mutation-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure mutation-tester
        run: |
          # Setup commands
          echo "Configuring mutation-tester"
```
