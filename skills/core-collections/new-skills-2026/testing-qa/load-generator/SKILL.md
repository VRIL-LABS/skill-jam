---
name: load-generator
description: Generate load tests — JMeter, Locust, or k6 scenarios. Use when performance testing, capacity planning, or stress testing.
---
...
Invoke this skill when you need to work with load generator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for load-generator"
```
...
Description of a basic use case for load-generator.
  ...
  deploy:
    ...
    steps:
      ...
      - name: Configure load-generator
        run: |
          # Setup commands
          echo "Configuring load-generator"
```
