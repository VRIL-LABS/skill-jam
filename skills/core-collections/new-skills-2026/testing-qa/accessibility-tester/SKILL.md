...
description: Test accessibility — WCAG compliance and a11y validation. Use when ensuring accessibility, testing screen readers, or meeting compliance requirements.
---
...
Invoke this skill when you need to work with accessibility tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for accessibility-tester"
```
...
Description of a basic use case for accessibility-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure accessibility-tester
        run: |
          # Setup commands
          echo "Configuring accessibility-tester"
```
