...
description: Run smoke tests — quick validation after deployment. Use when validating deployments, testing critical paths, or pre-production checks.
---
...
Invoke this skill when you need to work with smoke test runner in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for smoke-test-runner"
```
...
Description of a basic use case for smoke-test-runner.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure smoke-test-runner
        run: |
          # Setup commands
          echo "Configuring smoke-test-runner"
```
