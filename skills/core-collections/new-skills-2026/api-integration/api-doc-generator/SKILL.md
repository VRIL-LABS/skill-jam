...
description: Generate API documentation — Swagger, ReDoc, or API docs from code. Use when documenting APIs, creating developer portals, or generating specs.
---
...
Invoke this skill when you need to work with api doc generator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for api-doc-generator"
```
...
Description of a basic use case for api-doc-generator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure api-doc-generator
        run: |
          # Setup commands
          echo "Configuring api-doc-generator"
```
