...
description: Generate REST API clients — OpenAPI to code generation. Use when consuming APIs, generating SDKs, or creating type-safe clients.
---
...
Invoke this skill when you need to work with rest client generator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for rest-client-generator"
```
...
Description of a basic use case for rest-client-generator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure rest-client-generator
        run: |
          # Setup commands
          echo "Configuring rest-client-generator"
```
