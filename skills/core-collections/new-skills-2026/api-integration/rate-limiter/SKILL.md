---
name: rate-limiter
description: Implement rate limiting — token bucket, sliding window, or distributed rate limiting. Use when protecting APIs, preventing abuse, or implementing quotas.
---
...
Invoke this skill when you need to work with rate limiter in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for rate-limiter"
```
...
Description of a basic use case for rate-limiter.
