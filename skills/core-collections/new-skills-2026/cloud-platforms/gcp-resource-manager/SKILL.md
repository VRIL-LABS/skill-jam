...
description: Manage GCP resources — Compute Engine, Cloud Storage, Cloud SQL. Use when provisioning GCP resources, managing projects, or GCP infrastructure.
---
...
Invoke this skill when you need to work with gcp resource manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for gcp-resource-manager"
```
...
Description of a basic use case for gcp-resource-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure gcp-resource-manager
        run: |
          # Setup commands
          echo "Configuring gcp-resource-manager"
```
