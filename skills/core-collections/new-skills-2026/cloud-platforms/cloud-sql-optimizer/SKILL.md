---
name: cloud-sql-optimizer
description: Optimize cloud databases — Cloud SQL, RDS, or Azure SQL optimization. Use when tuning database performance, reducing costs, or implementing HA.
---
...
Invoke this skill when you need to work with cloud sql optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cloud-sql-optimizer"
```
...
Description of a basic use case for cloud-sql-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cloud-sql-optimizer
        run: |
          # Setup commands
          echo "Configuring cloud-sql-optimizer"
```
