...
description: Manage Azure resources — VMs, Storage, SQL Database, Functions. Use when provisioning Azure resources, managing subscriptions, or Azure deployments.
---
...
Invoke this skill when you need to work with azure resource manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for azure-resource-manager"
```
...
Description of a basic use case for azure-resource-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure azure-resource-manager
        run: |
          # Setup commands
          echo "Configuring azure-resource-manager"
```
