...
description: Manage AWS resources — EC2, S3, RDS, Lambda, and more. Use when provisioning AWS resources, managing infrastructure, or optimizing AWS usage.
---
...
Invoke this skill when you need to work with aws resource manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for aws-resource-manager"
```
...
Description of a basic use case for aws-resource-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure aws-resource-manager
        run: |
          # Setup commands
          echo "Configuring aws-resource-manager"
```
