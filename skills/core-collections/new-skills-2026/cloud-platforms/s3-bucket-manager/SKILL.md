...
description: Manage S3 buckets — lifecycle policies, versioning, and access control. Use when organizing S3 data, implementing policies, or managing storage.
---
...
Invoke this skill when you need to work with s3 bucket manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for s3-bucket-manager"
```
...
Description of a basic use case for s3-bucket-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure s3-bucket-manager
        run: |
          # Setup commands
          echo "Configuring s3-bucket-manager"
```
