...
description: Automate backup strategies — scheduling, retention policies, and disaster recovery. Use when implementing backup solutions, managing retention, or testing recovery.
---
...
Invoke this skill when you need to work with backup automator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for backup-automator"
```
...
Description of a basic use case for backup-automator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure backup-automator
        run: |
          # Setup commands
          echo "Configuring backup-automator"
```
