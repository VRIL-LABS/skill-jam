...
description: Plan and execute cloud migrations — assessment, strategy, and execution roadmap. Use when moving to cloud, planning migration waves, or evaluating migration approaches.
---
...
Invoke this skill when you need to work with cloud migration planner in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cloud-migration-planner"
```
...
Description of a basic use case for cloud-migration-planner.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cloud-migration-planner
        run: |
          # Setup commands
          echo "Configuring cloud-migration-planner"
```
