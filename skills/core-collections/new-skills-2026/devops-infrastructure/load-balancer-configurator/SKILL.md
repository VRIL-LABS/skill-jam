...
description: Configure load balancers — ALB, NLB, Cloud Load Balancing, or NGINX. Use when distributing traffic, implementing health checks, or setting up SSL termination.
---
...
Invoke this skill when you need to work with load balancer configurator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for load-balancer-configurator"
```
...
Description of a basic use case for load-balancer-configurator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure load-balancer-configurator
        run: |
          # Setup commands
          echo "Configuring load-balancer-configurator"
```
