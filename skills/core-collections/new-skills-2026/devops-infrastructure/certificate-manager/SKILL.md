...
description: Manage SSL/TLS certificates — automated issuance, renewal, and deployment. Use when setting up HTTPS, managing cert-manager in K8s, or automating certificate lifecycle.
---
...
Invoke this skill when you need to work with certificate manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for certificate-manager"
```
...
Description of a basic use case for certificate-manager.
  ...
  deploy:
    ...
    steps:
      ...
      - name: Configure certificate-manager
        run: |
          # Setup commands
          echo "Configuring certificate-manager"
```
