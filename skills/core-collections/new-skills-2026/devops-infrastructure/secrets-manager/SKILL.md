...
description: Manage secrets with Vault, AWS Secrets Manager, or Azure Key Vault — rotation, access control, and encryption. Use when securing secrets, implementing rotation policies, or managing credentials.
---
...
Invoke this skill when you need to work with secrets manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for secrets-manager"
```
...
Description of a basic use case for secrets-manager.
