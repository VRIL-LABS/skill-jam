...
description: Scan container images for vulnerabilities — Trivy, Clair, or Snyk integration. Use when securing containers, implementing CI security, or auditing image vulnerabilities.
---
...
Invoke this skill when you need to work with container scanner in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for container-scanner"
```
...
Description of a basic use case for container-scanner.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure container-scanner
        run: |
          # Setup commands
          echo "Configuring container-scanner"
```
