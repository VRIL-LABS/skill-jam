...
description: Configure service mesh (Istio, Linkerd) for microservices — traffic management, security, and observability. Use when implementing service-to-service communication, mTLS, traffic splitting, or advanced networking.
---
...
Invoke this skill when you need to work with service mesh configurator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for service-mesh-configurator"
```
...
Description of a basic use case for service-mesh-configurator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure service-mesh-configurator
        run: |
          # Setup commands
          echo "Configuring service-mesh-configurator"
```
