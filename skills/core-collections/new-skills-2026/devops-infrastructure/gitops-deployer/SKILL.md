...
description: Implement GitOps workflows with ArgoCD or Flux — declarative deployments and automated sync. Use when setting up GitOps, automating deployments from Git, or implementing continuous deployment.
---
...
Invoke this skill when you need to work with gitops deployer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for gitops-deployer"
```
...
Description of a basic use case for gitops-deployer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure gitops-deployer
        run: |
          # Setup commands
          echo "Configuring gitops-deployer"
```
