---
name: cdn-optimizer
description: Optimize content delivery with CDN — CloudFront, Cloudflare, or Fastly configuration. Use when improving performance, reducing latency, or implementing edge caching.
---
...
Invoke this skill when you need to work with cdn optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cdn-optimizer"
```
...
Description of a basic use case for cdn-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cdn-optimizer
        run: |
          # Setup commands
          echo "Configuring cdn-optimizer"
```
