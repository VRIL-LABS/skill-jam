...
description: Configure Kubernetes cluster autoscaling — node groups, scaling policies, and cost optimization. Use when implementing auto-scaling, optimizing costs, or handling variable loads.
---
...
Invoke this skill when you need to work with cluster autoscaler in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cluster-autoscaler"
```
...
Description of a basic use case for cluster-autoscaler.
