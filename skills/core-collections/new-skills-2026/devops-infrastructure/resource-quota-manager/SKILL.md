...
description: Manage Kubernetes resource quotas and limits — namespace quotas, limit ranges, and capacity planning. Use when implementing multi-tenancy, preventing resource exhaustion, or managing capacity.
---

# resource-quota-manager

Manage kubernetes resource quotas and limits.

## When to Use

Invoke this skill when you need to work with resource quota manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for resource-quota-manager"
```
...
Description of a basic use case for resource-quota-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure resource-quota-manager
        run: |
          # Setup commands
          echo "Configuring resource-quota-manager"
```
