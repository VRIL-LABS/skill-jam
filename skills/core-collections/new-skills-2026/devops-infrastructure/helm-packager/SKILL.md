---
name: helm-packager
description: Package and deploy Kubernetes applications with Helm charts — templating, versioning, and release management. Use when packaging K8s apps, managing multiple deployments, versioning releases, or sharing applications.
---
...
Invoke this skill when you need to work with helm packager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for helm-packager"
```
...
Description of a basic use case for helm-packager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure helm-packager
        run: |
          # Setup commands
          echo "Configuring helm-packager"
```
