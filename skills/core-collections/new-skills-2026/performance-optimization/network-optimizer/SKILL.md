...
description: Optimize network usage — compression, HTTP/2, and connection pooling. Use when reducing bandwidth, improving network performance, or optimizing requests.
---
...
Invoke this skill when you need to work with network optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for network-optimizer"
```
...
Description of a basic use case for network-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure network-optimizer
        run: |
          # Setup commands
          echo "Configuring network-optimizer"
```
