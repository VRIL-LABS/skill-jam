---
name: lazy-loader
description: Implement lazy loading — code splitting and dynamic imports. Use when optimizing initial load, implementing on-demand loading, or reducing bundle size.
---
...
Invoke this skill when you need to work with lazy loader in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for lazy-loader"
```
...
Description of a basic use case for lazy-loader.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure lazy-loader
        run: |
          # Setup commands
          echo "Configuring lazy-loader"
```
