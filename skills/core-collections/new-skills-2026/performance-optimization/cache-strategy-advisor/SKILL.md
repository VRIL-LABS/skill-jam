...
description: Design caching strategies — cache policies, invalidation, and TTL. Use when implementing caching, improving performance, or reducing database load.
---
...
Invoke this skill when you need to work with cache strategy advisor in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cache-strategy-advisor"
```
...
Description of a basic use case for cache-strategy-advisor.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cache-strategy-advisor
        run: |
          # Setup commands
          echo "Configuring cache-strategy-advisor"
```
