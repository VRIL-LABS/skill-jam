---
name: preload-optimizer
description: Optimize resource preloading — critical path optimization. Use when improving perceived performance, preloading assets, or optimizing render.
---
...
Invoke this skill when you need to work with preload optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for preload-optimizer"
```
...
Description of a basic use case for preload-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure preload-optimizer
        run: |
          # Setup commands
          echo "Configuring preload-optimizer"
```
