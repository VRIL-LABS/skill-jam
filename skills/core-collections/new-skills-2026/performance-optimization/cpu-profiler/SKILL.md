---
name: cpu-profiler
description: Profile CPU usage — hotspot detection and optimization. Use when optimizing performance, finding bottlenecks, or reducing CPU usage.
---
...
Invoke this skill when you need to work with cpu profiler in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cpu-profiler"
```
...
Description of a basic use case for cpu-profiler.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cpu-profiler
        run: |
          # Setup commands
          echo "Configuring cpu-profiler"
```
