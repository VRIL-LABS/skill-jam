---
name: error-tracker
description: Track and manage application errors — Sentry, Rollbar, or Bugsnag integration. Use when monitoring errors, debugging production issues, or tracking error trends.
---
...
Invoke this skill when you need to work with error tracker in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for error-tracker"
```
...
Description of a basic use case for error-tracker.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure error-tracker
        run: |
          # Setup commands
          echo "Configuring error-tracker"
```
