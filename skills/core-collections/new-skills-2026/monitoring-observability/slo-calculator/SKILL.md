---
name: slo-calculator
description: Calculate and track SLOs/SLIs — error budgets and availability targets. Use when defining reliability targets, tracking SLOs, or implementing error budgets.
---

# slo-calculator

Calculate and track slos/slis.

## When to Use

Invoke this skill when you need to work with slo calculator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for slo-calculator"
```
...
Description of a basic use case for slo-calculator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure slo-calculator
        run: |
          # Setup commands
          echo "Configuring slo-calculator"
```
