---
name: alert-manager
description: Configure alerting with AlertManager or PagerDuty — routing, grouping, and escalation. Use when setting up on-call, configuring notifications, or managing incidents.
---

# alert-manager

Configure alerting with alertmanager or pagerduty.

## When to Use

Invoke this skill when you need to work with alert manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for alert-manager"
```
...
Description of a basic use case for alert-manager.
