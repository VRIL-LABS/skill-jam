---
name: uptime-monitor
description: Monitor uptime and availability — synthetic checks and alerting. Use when tracking availability, implementing external monitoring, or SLA reporting.
---
...
Invoke this skill when you need to work with uptime monitor in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for uptime-monitor"
```
...
Description of a basic use case for uptime-monitor.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure uptime-monitor
        run: |
          # Setup commands
          echo "Configuring uptime-monitor"
```
