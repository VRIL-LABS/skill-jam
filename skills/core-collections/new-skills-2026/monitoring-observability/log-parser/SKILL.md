---
name: log-parser
description: Parse and analyze logs — patterns, extraction, and enrichment. Use when processing logs, extracting fields, or building log pipelines.
---
...
Invoke this skill when you need to work with log parser in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for log-parser"
```
...
Description of a basic use case for log-parser.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure log-parser
        run: |
          # Setup commands
          echo "Configuring log-parser"
```
