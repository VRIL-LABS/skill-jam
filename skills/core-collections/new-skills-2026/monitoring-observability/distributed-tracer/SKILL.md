...
description: Implement distributed tracing with Jaeger or Zipkin — request tracking and performance analysis. Use when debugging microservices, analyzing latency, or tracking requests.
---
...
Invoke this skill when you need to work with distributed tracer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for distributed-tracer"
```
...
Description of a basic use case for distributed-tracer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure distributed-tracer
        run: |
          # Setup commands
          echo "Configuring distributed-tracer"
```
