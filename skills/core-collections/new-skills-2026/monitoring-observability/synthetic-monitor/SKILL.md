...
description: Create synthetic monitoring — scripted transactions and user journeys. Use when monitoring user workflows, testing critical paths, or proactive detection.
---
...
Invoke this skill when you need to work with synthetic monitor in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for synthetic-monitor"
```
...
Description of a basic use case for synthetic-monitor.
  ...
  deploy:
    ...
    steps:
      ...
      - name: Configure synthetic-monitor
        run: |
          # Setup commands
          echo "Configuring synthetic-monitor"
```
