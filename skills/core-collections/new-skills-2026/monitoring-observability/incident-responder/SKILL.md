...
description: Respond to incidents — runbooks, escalation, and post-mortems. Use when handling incidents, documenting procedures, or conducting retrospectives.
---
...
Invoke this skill when you need to work with incident responder in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for incident-responder"
```
...
Description of a basic use case for incident-responder.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure incident-responder
        run: |
          # Setup commands
          echo "Configuring incident-responder"
```
