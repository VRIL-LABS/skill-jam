---
name: health-checker
description: Implement health checks — liveness, readiness, and startup probes. Use when monitoring service health, implementing graceful shutdown, or load balancer integration.
---
...
Invoke this skill when you need to work with health checker in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for health-checker"
```
...
Description of a basic use case for health-checker.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure health-checker
        run: |
          # Setup commands
          echo "Configuring health-checker"
```
