...
description: Anonymize sensitive data — PII masking and de-identification. Use when protecting privacy, masking data, or meeting compliance requirements.
---
...
Invoke this skill when you need to work with data anonymizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for data-anonymizer"
```
...
Description of a basic use case for data-anonymizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure data-anonymizer
        run: |
          # Setup commands
          echo "Configuring data-anonymizer"
```
