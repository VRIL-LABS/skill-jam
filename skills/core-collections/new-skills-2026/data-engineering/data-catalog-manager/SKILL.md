...
description: Manage data catalogs — metadata management and data discovery. Use when documenting data, enabling discovery, or implementing data governance.
---
...
Invoke this skill when you need to work with data catalog manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for data-catalog-manager"
```
...
Description of a basic use case for data-catalog-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure data-catalog-manager
        run: |
          # Setup commands
          echo "Configuring data-catalog-manager"
```
