...
description: Migrate database schemas — version control and automated migrations. Use when evolving schemas, managing database changes, or deploying schema updates.
---
...
Invoke this skill when you need to work with schema migrator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for schema-migrator"
```
...
Description of a basic use case for schema-migrator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure schema-migrator
        run: |
          # Setup commands
          echo "Configuring schema-migrator"
```
