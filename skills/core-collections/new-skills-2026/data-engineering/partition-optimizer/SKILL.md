---
name: partition-optimizer
description: Optimize data partitioning — Hive, Spark, or BigQuery partitioning strategies. Use when improving query performance, reducing costs, or organizing data.
---
...
Invoke this skill when you need to work with partition optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for partition-optimizer"
```
...
Description of a basic use case for partition-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure partition-optimizer
        run: |
          # Setup commands
          echo "Configuring partition-optimizer"
```
