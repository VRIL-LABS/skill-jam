...
description: Process streaming data — Kafka Streams, Flink, or Spark Streaming. Use when processing real-time data, building stream pipelines, or event processing.
---
...
Invoke this skill when you need to work with stream processor in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for stream-processor"
```
...
Description of a basic use case for stream-processor.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure stream-processor
        run: |
          # Setup commands
