...
description: Build email templates — responsive HTML emails and templating. Use when creating email campaigns, building transactional emails, or email design.
---
...
Invoke this skill when you need to work with email template builder in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for email-template-builder"
```
...
Description of a basic use case for email-template-builder.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure email-template-builder
        run: |
          # Setup commands
          echo "Configuring email-template-builder"
```
