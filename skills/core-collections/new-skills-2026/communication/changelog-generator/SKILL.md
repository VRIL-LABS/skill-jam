...
description: Generate changelogs from commits — semantic versioning and release notes. Use when creating releases, documenting changes, or maintaining changelogs.
---
...
Invoke this skill when you need to work with changelog generator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for changelog-generator"
```
...
Description of a basic use case for changelog-generator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure changelog-generator
        run: |
          # Setup commands
