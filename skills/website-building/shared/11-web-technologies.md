---
name: website-building-web-technologies
description: Framework versions, browser support baselines, and emerging web platform features for 2026.
---


## Framework Versions (Current — 2026)

| Framework | Latest Version | Notes |
|---|---|---|
| **Next.js** | 16.x | Turbopack by default, `"use cache"` directive, proxy.ts replaces middleware.ts, React 19.2, Node 20.9+ required |
| **React** | 19.2 | React Compiler stable, view transitions, improved Suspense |
| **React Native** | 0.81 | New Architecture default, React 19 support |
| **Expo SDK** | 54 | XCFrameworks for iOS, full RN 0.81 + React 19 support |
| **Tailwind CSS** | v4.0.4+ | CSS-first config, Oxide engine (Rust), `@import "tailwindcss"`, `@theme` |
| **shadcn/ui** | latest | Compatible with both Tailwind v3 and v4 |
| **Vite** | 6.x | |
