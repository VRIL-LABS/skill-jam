---
name: cdn-configurator
description: Configure CDN caching — edge caching, cache headers, and purging. Use when optimizing content delivery, reducing latency, or implementing edge caching.
---
...
Invoke this skill when you need to work with cdn configurator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for cdn-configurator"
```
...
Description of a basic use case for cdn-configurator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure cdn-configurator
        run: |
          # Setup commands
          echo "Configuring cdn-configurator"
```
