...
description: Analyze JavaScript bundles — code splitting and tree shaking. Use when optimizing bundle size, reducing load times, or analyzing dependencies.
---
...
Invoke this skill when you need to work with bundle analyzer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for bundle-analyzer"
```
...
Description of a basic use case for bundle-analyzer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure bundle-analyzer
        run: |
          # Setup commands
          echo "Configuring bundle-analyzer"
```
