...
description: Optimize database queries — index recommendations and query rewriting. Use when improving query performance, reducing latency, or optimizing database usage.
---
...
Invoke this skill when you need to work with query optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for query-optimizer"
```
...
Description of a basic use case for query-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure query-optimizer
        run: |
          # Setup commands
          echo "Configuring query-optimizer"
```
