...
description: Manage container registries — ECR, ACR, GCR, or Harbor administration. Use when organizing images, implementing policies, or managing access control.
---
...
Invoke this skill when you need to work with registry manager in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for registry-manager"
```
...
Description of a basic use case for registry-manager.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure registry-manager
        run: |
          # Setup commands
          echo "Configuring registry-manager"
```
