...
description: Design disaster recovery strategies — RTO/RPO planning, backup strategies, and failover procedures. Use when planning business continuity, implementing DR, or testing recovery procedures.
---
...
Invoke this skill when you need to work with disaster recovery planner in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for disaster-recovery-planner"
```
...
Description of a basic use case for disaster-recovery-planner.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure disaster-recovery-planner
        run: |
          # Setup commands
          echo "Configuring disaster-recovery-planner"
```
