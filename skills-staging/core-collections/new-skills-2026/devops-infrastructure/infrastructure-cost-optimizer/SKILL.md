...
description: Optimize cloud infrastructure costs — resource right-sizing, reserved instances, and cost allocation. Use when reducing cloud spend, analyzing cost trends, or implementing cost governance.
---
...
Invoke this skill when you need to work with infrastructure cost optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for infrastructure-cost-optimizer"
```
...
Description of a basic use case for infrastructure-cost-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure infrastructure-cost-optimizer
        run: |
          # Setup commands
          echo "Configuring infrastructure-cost-optimizer"
```
