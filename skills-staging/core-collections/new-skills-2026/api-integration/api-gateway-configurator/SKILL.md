...
description: Configure API gateways — Kong, AWS API Gateway, or Apigee. Use when managing APIs, implementing security, or rate limiting.
---
...
Invoke this skill when you need to work with api gateway configurator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for api-gateway-configurator"
```
...
Description of a basic use case for api-gateway-configurator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure api-gateway-configurator
        run: |
          # Setup commands
          echo "Configuring api-gateway-configurator"
```
