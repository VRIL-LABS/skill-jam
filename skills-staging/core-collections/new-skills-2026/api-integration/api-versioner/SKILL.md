---
name: api-versioner
description: Manage API versions — versioning strategies and deprecation. Use when evolving APIs, maintaining backwards compatibility, or deprecating endpoints.
---
...
Invoke this skill when you need to work with api versioner in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for api-versioner"
```
...
Description of a basic use case for api-versioner.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure api-versioner
        run: |
          # Setup commands
          echo "Configuring api-versioner"
```
