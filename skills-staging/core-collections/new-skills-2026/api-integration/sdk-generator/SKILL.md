---
name: sdk-generator
description: Generate SDKs — multi-language client libraries from API specs. Use when providing client libraries, improving developer experience, or distributing SDKs.
---
...
Invoke this skill when you need to work with sdk generator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for sdk-generator"
```
...
Description of a basic use case for sdk-generator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure sdk-generator
        run: |
          # Setup commands
          echo "Configuring sdk-generator"
```
