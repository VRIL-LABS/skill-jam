---
name: apm-integrator
description: Integrate APM tools (New Relic, Datadog, AppDynamics) — application performance monitoring. Use when monitoring app performance, tracking errors, or analyzing user experience.
---

# apm-integrator

Integrate apm tools (new relic, datadog, appdynamics).

## When to Use

Invoke this skill when you need to work with apm integrator in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for apm-integrator"
```
...
Description of a basic use case for apm-integrator.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure apm-integrator
        run: |
          # Setup commands
          echo "Configuring apm-integrator"
```
