...
description: Analyze application performance — profiling, bottleneck detection, and optimization. Use when investigating slowness, optimizing performance, or capacity planning.
---
...
Invoke this skill when you need to work with performance analyzer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for performance-analyzer"
```
...
Description of a basic use case for performance-analyzer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure performance-analyzer
        run: |
          # Setup commands
          echo "Configuring performance-analyzer"
```
