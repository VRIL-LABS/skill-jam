---
name: data-versioner
description: Version data — dataset versioning and snapshot management. Use when tracking data changes, implementing rollback, or managing data versions.
---
...
Invoke this skill when you need to work with data versioner in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for data-versioner"
```
...
Description of a basic use case for data-versioner.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure data-versioner
        run: |
          # Setup commands
          echo "Configuring data-versioner"
```
