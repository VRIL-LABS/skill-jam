---
name: columnar-optimizer
description: Optimize columnar storage — Parquet, ORC, or columnar database tuning. Use when optimizing storage, improving query performance, or reducing costs.
---
...
Invoke this skill when you need to work with columnar optimizer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for columnar-optimizer"
```
...
Description of a basic use case for columnar-optimizer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure columnar-optimizer
        run: |
          # Setup commands
          echo "Configuring columnar-optimizer"
```
