...
description: Track data lineage — source-to-target mapping and impact analysis. Use when understanding data flow, debugging pipelines, or compliance reporting.
---
...
Invoke this skill when you need to work with data lineage tracker in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for data-lineage-tracker"
```
...
Description of a basic use case for data-lineage-tracker.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure data-lineage-tracker
        run: |
          # Setup commands
          echo "Configuring data-lineage-tracker"
```
