...
description: Write release notes — feature summaries and change documentation. Use when documenting releases, communicating changes, or creating announcements.
---
...
Invoke this skill when you need to work with release notes writer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for release-notes-writer"
```
...
Description of a basic use case for release-notes-writer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure release-notes-writer
        run: |
          # Setup commands
          echo "Configuring release-notes-writer"
```
