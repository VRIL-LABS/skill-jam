---
name: slack-notifier
description: Send Slack notifications — messages, alerts, and integrations. Use when implementing notifications, alerting teams, or building Slack integrations.
---
...
Invoke this skill when you need to work with slack notifier in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for slack-notifier"
```
...
Description of a basic use case for slack-notifier.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure slack-notifier
        run: |
          # Setup commands
          echo "Configuring slack-notifier"
```
