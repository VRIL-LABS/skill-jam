...
description: Send push notifications — Firebase, APNs, or OneSignal integration. Use when implementing mobile notifications, sending alerts, or engagement campaigns.
---
...
Invoke this skill when you need to work with push notification sender in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for push-notification-sender"
```
...
Description of a basic use case for push-notification-sender.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure push-notification-sender
        run: |
          # Setup commands
          echo "Configuring push-notification-sender"
```
