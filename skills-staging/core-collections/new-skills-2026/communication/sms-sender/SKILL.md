---
name: sms-sender
description: Send SMS messages — Twilio, AWS SNS, or other providers. Use when implementing SMS notifications, 2FA, or alerts.
---
...
Invoke this skill when you need to work with sms sender in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for sms-sender"
```
...
Description of a basic use case for sms-sender.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure sms-sender
        run: |
          # Setup commands
          echo "Configuring sms-sender"
```
