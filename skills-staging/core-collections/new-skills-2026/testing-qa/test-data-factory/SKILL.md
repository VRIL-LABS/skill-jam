...
description: Generate test data — fixtures, factories, and data builders. Use when creating test data, seeding databases, or generating realistic data.
---
...
Invoke this skill when you need to work with test data factory in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for test-data-factory"
```
...
Description of a basic use case for test-data-factory.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure test-data-factory
        run: |
          # Setup commands
          echo "Configuring test-data-factory"
```
