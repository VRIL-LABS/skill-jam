...
description: Implement snapshot testing — UI and data snapshot validation. Use when testing React components, validating output, or detecting unexpected changes.
---
...
Invoke this skill when you need to work with snapshot tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for snapshot-tester"
```
...
Description of a basic use case for snapshot-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure snapshot-tester
        run: |
          # Setup commands
          echo "Configuring snapshot-tester"
```
