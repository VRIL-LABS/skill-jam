---
name: chaos-engineer
description: Implement chaos engineering — failure injection and resilience testing. Use when testing fault tolerance, validating recovery, or improving reliability.
---
...
Invoke this skill when you need to work with chaos engineer in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for chaos-engineer"
```
...
Description of a basic use case for chaos-engineer.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure chaos-engineer
        run: |
          # Setup commands
          echo "Configuring chaos-engineer"
```
