...
description: Test visual regressions — screenshot comparison and UI testing. Use when preventing UI bugs, testing across browsers, or validating designs.
---
...
Invoke this skill when you need to work with visual regression tester in your infrastructure or application.

## Quick Start

```bash
# Example command or configuration
echo "Sample usage for visual-regression-tester"
```
...
Description of a basic use case for visual-regression-tester.
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Configure visual-regression-tester
        run: |
          # Setup commands
          echo "Configuring visual-regression-tester"
```
